...
//    [button1 setImagePosition];
    ...
    UIButton *button15 = [UIButton buttonWithNormalTitle:@"垂直居中-宽不足-图片左" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"icon_coin24"] frame:CGRectMake(20, CGRectGetMaxY(button14.frame)+10, 34, 80)];
    button15.backgroundColor = [UIColor blackColor];
    [button15 setImagePosition:JPButtonImagePosition_Left margin:10];
    [scrollView addSubview:button15];
    
    UIButton *button16 = [UIButton buttonWithNormalTitle:@"垂直居中-宽不足-图片右" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"icon_coin24"] frame:CGRectMake(20, CGRectGetMaxY(button15.frame)+10, 34, 80)];
    button16.backgroundColor = [UIColor blackColor];
    [button16 setImagePosition:JPButtonImagePosition_Right margin:10];
    [scrollView addSubview:button16];

    UIButton *button17 = [UIButton buttonWithNormalTitle:@"垂直居中-宽不足-图片上" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"icon_coin24"] frame:CGRectMake(20, CGRectGetMaxY(button16.frame)+10, 40, 30)];
    button17.backgroundColor = [UIColor blackColor];
    [button17 setImagePosition:JPButtonImagePosition_Top margin:10];
    [scrollView addSubview:button17];
    //stey_fit_icon_play_64
    UIButton *button171 = [UIButton buttonWithNormalTitle:@"继续" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"stey_fit_icon_play_64"] frame:CGRectMake(20, CGRectGetMaxY(button17.frame)+10, 64, 90)];
    button171.backgroundColor = [UIColor blackColor];
    [button171 setImagePosition:JPButtonImagePosition_Top margin:10];
    [scrollView addSubview:button171];
    
    UIButton *button172 = [UIButton buttonWithNormalTitle:@"继续继续继续" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"stey_fit_icon_play_64"] frame:CGRectMake(20, CGRectGetMaxY(button171.frame)+10, 100, 90)];
    button172.backgroundColor = [UIColor blackColor];
    [button172 setImagePosition:JPButtonImagePosition_Top margin:10];
    [scrollView addSubview:button172];

    UIButton *button18 = [UIButton buttonWithNormalTitle:@"垂直居中-宽不足-图片下" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"icon_coin24"] frame:CGRectMake(20, CGRectGetMaxY(button172.frame)+10, 34, 80)];
    button18.backgroundColor = [UIColor blackColor];
    [button18 setImagePosition:JPButtonImagePosition_Bottom margin:10];
    [scrollView addSubview:button18];
    
    UIButton *button181 = [UIButton buttonWithNormalTitle:@"继续" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"stey_fit_icon_play_64"] frame:CGRectMake(20, CGRectGetMaxY(button18.frame)+10, 64, 90)];
    button181.backgroundColor = [UIColor blackColor];
    [button181 setImagePosition:JPButtonImagePosition_Bottom margin:10];
    [scrollView addSubview:button181];
    
    UIButton *button182 = [UIButton buttonWithNormalTitle:@"继续继续继续" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"stey_fit_icon_play_64"] frame:CGRectMake(20, CGRectGetMaxY(button181.frame)+10, 100, 90)];
    button182.backgroundColor = [UIColor blackColor];
    [button182 setImagePosition:JPButtonImagePosition_Bottom margin:10];
    [scrollView addSubview:button182];

    UIButton *button19 = [UIButton buttonWithNormalTitle:@"垂直居上-宽不足-图片左" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"icon_coin24"] frame:CGRectMake(20, CGRectGetMaxY(button182.frame)+10, 34, 80)];
    button19.backgroundColor = [UIColor blackColor];
    button19.contentVerticalAlignment = UIControlContentVerticalAlignmentTop;
    [button19 setImagePosition:JPButtonImagePosition_Left margin:10];
    [scrollView addSubview:button19];
    
    UIButton *button20 = [UIButton buttonWithNormalTitle:@"垂直居上-宽不足-图片右" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"icon_coin24"] frame:CGRectMake(20, CGRectGetMaxY(button19.frame)+10, 34, 80)];
    button20.backgroundColor = [UIColor blackColor];
    button20.contentVerticalAlignment = UIControlContentVerticalAlignmentTop;
    [button20 setImagePosition:JPButtonImagePosition_Right margin:10];
    [scrollView addSubview:button20];

    UIButton *button21 = [UIButton buttonWithNormalTitle:@"垂直居上-宽不足-图片上" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"icon_coin24"] frame:CGRectMake(20, CGRectGetMaxY(button20.frame)+10, 24, 30)];
    button21.backgroundColor = [UIColor blackColor];
    button21.contentVerticalAlignment = UIControlContentVerticalAlignmentTop;
    [button21 setImagePosition:JPButtonImagePosition_Top margin:10];
    [scrollView addSubview:button21];
    
    UIButton *button211 = [UIButton buttonWithNormalTitle:@"继续" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"stey_fit_icon_play_64"] frame:CGRectMake(20, CGRectGetMaxY(button21.frame)+10, 64, 90)];
    button211.backgroundColor = [UIColor blackColor];
    button21.contentVerticalAlignment = UIControlContentVerticalAlignmentTop;
    [button211 setImagePosition:JPButtonImagePosition_Top margin:10];
    [scrollView addSubview:button211];
    
    UIButton *button212 = [UIButton buttonWithNormalTitle:@"继续继续继续" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"stey_fit_icon_play_64"] frame:CGRectMake(20, CGRectGetMaxY(button211.frame)+10, 100, 90)];
    button212.backgroundColor = [UIColor blackColor];
    button21.contentVerticalAlignment = UIControlContentVerticalAlignmentTop;
    [button212 setImagePosition:JPButtonImagePosition_Top margin:10];
    [scrollView addSubview:button212];


    UIButton *button22 = [UIButton buttonWithNormalTitle:@"垂直居上-宽不足-图片下" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"icon_coin24"] frame:CGRectMake(20, CGRectGetMaxY(button212.frame)+10, 34, 80)];
    button22.backgroundColor = [UIColor blackColor];
    button22.contentVerticalAlignment = UIControlContentVerticalAlignmentTop;
    [button22 setImagePosition:JPButtonImagePosition_Bottom margin:10];
    [scrollView addSubview:button22];
    
    UIButton *button221 = [UIButton buttonWithNormalTitle:@"继续" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"stey_fit_icon_play_64"] frame:CGRectMake(20, CGRectGetMaxY(button22.frame)+10, 64, 90)];
    button221.backgroundColor = [UIColor blackColor];
    button221.contentVerticalAlignment = UIControlContentVerticalAlignmentTop;
    [button221 setImagePosition:JPButtonImagePosition_Bottom margin:10];
    [scrollView addSubview:button221];
    
    UIButton *button222 = [UIButton buttonWithNormalTitle:@"继续继续继续" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"stey_fit_icon_play_64"] frame:CGRectMake(20, CGRectGetMaxY(button221.frame)+10, 100, 90)];
    button222.backgroundColor = [UIColor blackColor];
    button222.contentVerticalAlignment = UIControlContentVerticalAlignmentTop;
    [button222 setImagePosition:JPButtonImagePosition_Bottom margin:10];
    [scrollView addSubview:button222];


    UIButton *button23 = [UIButton buttonWithNormalTitle:@"垂直居下-宽不足-图片左" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"icon_coin24"] frame:CGRectMake(20, CGRectGetMaxY(button222.frame)+10, 34, 80)];
    button23.backgroundColor = [UIColor blackColor];
    button23.contentVerticalAlignment = UIControlContentVerticalAlignmentBottom;
    [button23 setImagePosition:JPButtonImagePosition_Left margin:10];
    [scrollView addSubview:button23];
    
    UIButton *button24 = [UIButton buttonWithNormalTitle:@"垂直居下-宽不足-图片右" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"icon_coin24"] frame:CGRectMake(20, CGRectGetMaxY(button23.frame)+10, 34, 80)];
    button24.backgroundColor = [UIColor blackColor];
    button24.contentVerticalAlignment = UIControlContentVerticalAlignmentBottom;
    [button24 setImagePosition:JPButtonImagePosition_Right margin:10];
    [scrollView addSubview:button24];

    UIButton *button25 = [UIButton buttonWithNormalTitle:@"垂直居下-宽不足-图片上" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"icon_coin24"] frame:CGRectMake(20, CGRectGetMaxY(button24.frame)+10, 24, 30)];
    button25.backgroundColor = [UIColor blackColor];
    button25.contentVerticalAlignment = UIControlContentVerticalAlignmentBottom;
    [button25 setImagePosition:JPButtonImagePosition_Top margin:10];
    [scrollView addSubview:button25];
    
    UIButton *button251 = [UIButton buttonWithNormalTitle:@"继续" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"stey_fit_icon_play_64"] frame:CGRectMake(20, CGRectGetMaxY(button25.frame)+10, 64, 90)];
    button251.backgroundColor = [UIColor blackColor];
    button251.contentVerticalAlignment = UIControlContentVerticalAlignmentBottom;
    [button251 setImagePosition:JPButtonImagePosition_Top margin:10];
    [scrollView addSubview:button251];
    
    UIButton *button252 = [UIButton buttonWithNormalTitle:@"继续继续继续" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"stey_fit_icon_play_64"] frame:CGRectMake(20, CGRectGetMaxY(button251.frame)+10, 100, 90)];
    button252.backgroundColor = [UIColor blackColor];
    button252.contentVerticalAlignment = UIControlContentVerticalAlignmentBottom;
    [button252 setImagePosition:JPButtonImagePosition_Top margin:10];
    [scrollView addSubview:button252];

    UIButton *button26 = [UIButton buttonWithNormalTitle:@"垂直居下-宽不足-图片下" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"icon_coin24"] frame:CGRectMake(20, CGRectGetMaxY(button252.frame)+10, 34, 80)];
    button26.backgroundColor = [UIColor blackColor];
    button26.contentVerticalAlignment = UIControlContentVerticalAlignmentBottom;
    [button26 setImagePosition:JPButtonImagePosition_Bottom margin:10];
    [scrollView addSubview:button26];

    UIButton *button261 = [UIButton buttonWithNormalTitle:@"继续" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"stey_fit_icon_play_64"] frame:CGRectMake(20, CGRectGetMaxY(button26.frame)+10, 64, 90)];
    button261.backgroundColor = [UIColor blackColor];
    button261.contentVerticalAlignment = UIControlContentVerticalAlignmentBottom;
    [button261 setImagePosition:JPButtonImagePosition_Bottom margin:10];
    [scrollView addSubview:button261];
    
    UIButton *button262 = [UIButton buttonWithNormalTitle:@"继续继续继续" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor redColor] normalImage:[UIImage imageNamed:@"stey_fit_icon_play_64"] frame:CGRectMake(20, CGRectGetMaxY(button261.frame)+10, 100, 90)];
    button262.backgroundColor = [UIColor blackColor];
    button262.contentVerticalAlignment = UIControlContentVerticalAlignmentBottom;
    [button262 setImagePosition:JPButtonImagePosition_Bottom margin:10];
