...
//    [button1 jp_buttonImagePosition];
    ...
    UIButton *button21 = [UIButton jp_buttonWithNormalTitle:@"垂直居中-图片居左-间距10" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor whiteColor] normalImage:[UIImage imageNamed:@"icon_coin24"] frame:CGRectMake(20, CGRectGetMaxY(button2.frame) + 10, 50, 50)];
    button21.backgroundColor = [UIColor blackColor];
    button21.contentHorizontalAlignment = UIControlContentHorizontalAlignmentRight;
    [button21 jp_buttonImagePosition:JPButtonImagePosition_Left margin:10];
    [scrollView addSubview:button21];
    
    UIButton *button3 = [UIButton jp_buttonWithNormalTitle:@"垂直居中-图片居右-间距10" titleFont:[UIFont systemFontOfSize:15] normalTitleColor:[UIColor whiteColor] normalImage:[UIImage imageNamed:@"icon_coin24"] frame:CGRectMake(20, CGRectGetMaxY(button21.frame) + 10, 350, 50)];
    ...
    button41.contentHorizontalAlignment = UIControlContentHorizontalAlignmentRight;
    ...
    button51.contentHorizontalAlignment = UIControlContentHorizontalAlignmentRight;
    ...
    button81.contentHorizontalAlignment = UIControlContentHorizontalAlignmentRight;
    ...
    button91.contentHorizontalAlignment = UIControlContentHorizontalAlignmentRight;
    ...
    button131.contentHorizontalAlignment = UIControlContentHorizontalAlignmentRight;
    ...
    button141.contentHorizontalAlignment = UIControlContentHorizontalAlignmentRight;
