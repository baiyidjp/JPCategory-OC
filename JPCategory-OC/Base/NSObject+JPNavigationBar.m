...
+ (void)load {
    ...
    dispatch_once(&onceToken, ^{
        if (@available(iOS 11.0, *)) {
            ...
            [NSObject jp_swizzledInstanceMethodWithOriginalClass:cls swizzledClass:self originalSelector:NSSelectorFromString(@"_updateMarginConstraints") swizzledSelector:@selector(jp_updateMarginConstraints)];
        }
    });
}
